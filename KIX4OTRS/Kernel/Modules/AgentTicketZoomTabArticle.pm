    ...
    if ( $Self->{ArticleFilterActive} && $Self->{ArticleFilter} ) {
        ...
        for my $Article (@ArticleBox) {
            ...
            if (
                ...
                &&  !grep { $_ eq  $Article->{ArticleSenderTypeID} } @{ $Self->{ArticleFilter}->{ArticleSenderTypeID} }
                )
            {
                next ARTICLE;
            }
...
sub _ArticleMenu {
    ...
    if (
        ...
        && ( !defined $AclActionLookup{AgentTicketForward} || $AclActionLookup{AgentTicketForward} )
    ...
    if (
        ...
        && ( !defined $AclActionLookup{AgentTicketBounce} || $AclActionLookup{AgentTicketBounce} )
    ...
    if (
        ...
        && ( !defined $AclActionLookup{AgentArticleCopyMove} || $AclActionLookup{AgentArticleCopyMove} )
    ...
    if (
        ...
        && (
            !defined $AclAction{AgentArticleEdit}
            || $AclAction{AgentArticleEdit}
        )
    ...
    if (
        ...
        && (
            !defined $AclAction{AgentTicketAttachmentDownload}
            || $AclAction{AgentTicketAttachmentDownload}
        )
        )
    {
        my $Access = 1;
